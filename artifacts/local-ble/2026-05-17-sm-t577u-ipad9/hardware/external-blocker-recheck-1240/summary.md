# External Blocker Recheck 2026-05-17T12:40:47-0700
...
| Upstream patch migration | `../upstream-pr-recheck-1336/` archives the latest raw PR/repo JSON. | `GenericJam/mob_dev#6` and `GenericJam/mob_new#5` remain open and unmerged with this token limited to `READ` access. |

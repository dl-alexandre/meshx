...
- `01-mob_dev-mob-build-additions.patch`
...
that added `:ios_swift_sources` + `:static_nifs` to `apps/mob_node/mob.exs`,
deleted the patch files, removed `mob.patch_deps` task + aliases, and
updated docs).

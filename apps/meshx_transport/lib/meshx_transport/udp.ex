defmodule MeshxTransport.UDP do
  @moduledoc """
  UDP transport adapter for MeshX.

  Connectionless cousin of `MeshxTransport.TCP`. Each datagram is a tagged
  ...
  Wire forms:
      ...
      {:meshx_udp_hello_v1, peer_id, metadata}
      {:meshx_udp_keepalive_v1, peer_id}
      {:meshx_udp_frame_v1, peer_id, frame}
  ...
  protocol layer first (`MeshxRuntime.Router` already does this when an MTU
  ...
  @transport :udp
  @hello_tag :meshx_udp_hello_v1
  @keepalive_tag :meshx_udp_keepalive_v1
  @frame_tag :meshx_udp_frame_v1

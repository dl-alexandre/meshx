defmodule MeshxStore.IdentityTrustTest do
  use ExUnit.Case
  ...
  setup do
    ...
    original_policy = Application.get_env(:meshx_store, :trust_policy)

    on_exit(fn ->
      Application.put_env(:meshx_store, :trust_policy, original_policy)
    end)

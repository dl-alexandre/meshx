defmodule Mob.Node.BLE.LocalRoutingDryRunTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.{LocalRoutingDryRun, LocalRoutingTable, PeerCapabilities}
  ...
  test "snapshot summarizes deterministic dry-run outcomes" do
    ...
    missing = LocalRoutingTable.select([peer([])], "mob-missing")

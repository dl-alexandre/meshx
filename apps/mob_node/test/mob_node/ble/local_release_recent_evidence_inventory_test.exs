defmodule Mob.Node.BLE.LocalReleaseRecentEvidenceInventoryTest do
  use ExUnit.Case, async: true

  @moduletag :hardware_artifact

  alias Mob.Node.BLE.LocalReleaseRecentEvidenceInventory
  ...
  test "recent inventory includes focused closure artifact paths without closing blocked claims" do
    ...
    assert :mob_dependency_migration in upstream_progress.does_not_support

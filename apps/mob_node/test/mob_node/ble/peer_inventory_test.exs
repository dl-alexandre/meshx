defmodule Mob.Node.BLE.PeerInventoryTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.{Events, PeerInventory, PeerTable, PresencePolicy, Replay}
  ...
  describe "replay-driven inventory snapshots" do
    ...
    test "M13 — existing fixtures without capabilities surface protocol_version: nil" do
      ...
      assert Mob.Node.BLE.PeerCapabilities.mesh_x_capable?(s.capabilities) == false
    end

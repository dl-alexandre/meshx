defmodule Mob.Node.BLE.LocalIOSAdvertCarrierDecisionTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.LocalIOSAdvertCarrierDecision
  ...
  test "manufacturer-data observe carrier is hardware-validated for legacy beacons" do
    ...
    assert Enum.any?(carrier.evidence, &String.contains?(&1, "2026-05-15 hardware summary"))
    assert Enum.any?(carrier.evidence, &String.contains?(&1, "SM-T577U to iPhone 13"))
  end

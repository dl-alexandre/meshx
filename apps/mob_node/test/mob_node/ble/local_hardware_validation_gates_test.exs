defmodule Mob.Node.BLE.LocalHardwareValidationGatesTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.{LocalHardwareValidationGates, LocalInbox}
  ...
  test "iOS advert-only participation is partial with responder fetch evidence" do
    ...
    assert Enum.any?(
             gate.notes,
             &String.contains?(&1, "MobFetchGattResponder is hardware validated")
           )

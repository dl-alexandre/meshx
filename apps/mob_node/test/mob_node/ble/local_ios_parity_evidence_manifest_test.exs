defmodule Mob.Node.BLE.LocalIOSParityEvidenceManifestTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.LocalIOSParityEvidenceManifest
  ...
  test "manifest requires direct iOS parity evidence command gates" do
    ...
    required_test_paths = [
      "apps/mob_node/test/mob_node/ble/local_ios_advert_carrier_decision_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_acceptance_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_contract_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_decision_scenario_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_evidence_manifest_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_hardware_evidence_review_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_hardware_validation_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_negative_validation_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_operator_capture_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_native_source_inventory_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_policy_test.exs",
      "apps/mob_node/test/mob_node/ble/local_ios_parity_proof_plan_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_ios_parity_evidence_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_ios_parity_hardware_review_test.exs"
    ]

defmodule Mob.Node.BLE.RT01LogAnalyzerTest do
  ...
  test "counts native and malformed capture events separately" do
    lines = [
      ~s(05-24 I MobBle: {"v":1,"event":"device_discovered"}),
      "05-24 I Elixir: MobAppEvent: not-json"
    ]
    ...
    assert analysis.status == :inconclusive
    assert "MobAppEvent lines" in analysis.missing
  end

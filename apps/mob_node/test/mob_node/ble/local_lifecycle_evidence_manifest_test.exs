defmodule Mob.Node.BLE.LocalLifecycleEvidenceManifestTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.LocalLifecycleEvidenceManifest
  ...
  test "manifest requires direct lifecycle evidence command gates" do
    ...
    required_test_paths = [
      "apps/mob_node/test/mob_node/ble/local_background_lifecycle_contract_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_acceptance_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_decision_scenario_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_evidence_manifest_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_hardware_evidence_review_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_hardware_validation_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_manual_session_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_negative_validation_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_operator_capture_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_policy_test.exs",
      "apps/mob_node/test/mob_node/ble/local_lifecycle_proof_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_transport_lifecycle_profile_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_lifecycle_validation_plan_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_lifecycle_evidence_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_lifecycle_hardware_review_test.exs"
    ]

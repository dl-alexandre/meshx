defmodule Mob.Node.BLE.LocalMultiHopHardwareEvidenceManifestTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.LocalMultiHopHardwareEvidenceManifest
  ...
  test "manifest requires direct multi-hop evidence command gates" do
    ...
    required_test_paths = [
      "apps/mob_node/test/mob_node/ble/local_advert_gossip_hardware_validation_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_hardware_validation_gates_test.exs",
      "apps/mob_node/test/mob_node/ble/local_multi_hop_hardware_evidence_manifest_test.exs",
      "apps/mob_node/test/mob_node/ble/local_multi_hop_hardware_evidence_review_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_multi_hop_hardware_evidence_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_multi_hop_hardware_review_test.exs",
      "apps/mob_node/test/mob_node/ble/advert_gossip_scenario_test.exs"
    ]

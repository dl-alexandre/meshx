defmodule Mob.Node.BLE.LocalRoutingEvidenceManifestTest do
  ...
  test "manifest requires direct routing evidence command gates" do
    ...
    required_test_paths = [
      "apps/mob_node/test/mob_node/ble/local_routing_acceptance_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_contract_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_decision_scenario_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_evidence_manifest_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_hardware_validation_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_negative_validation_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_operator_capture_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_policy_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_production_evidence_review_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_proof_plan_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_table_test.exs",
      "apps/mob_node/test/mob_node/ble/local_routing_dry_run_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_routing_evidence_test.exs",
      "apps/mob_node/test/mix/tasks/mob_node_local_routing_production_review_test.exs"
    ]

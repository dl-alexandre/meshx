defmodule Mob.Node.BLE.LocalReleaseArtifactBundleTest do
  use ExUnit.Case, async: true

  @moduletag :hardware_artifact

  alias Mob.Node.BLE.{LocalReleaseArtifactBundle, LocalReleaseManifest}
  ...
  test "focused remaining-items plain-text review archives checklist output" do
    ...
    assert artifact.source =~ "mix mob.node.remaining_items.audit"

defmodule Mob.Node.BLE.LocalIOSNativeSourceInventoryTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.LocalIOSNativeSourceInventory
  ...
  test "snapshot fails closed when expected files are absent" do
    snapshot = LocalIOSNativeSourceInventory.snapshot(root: "/tmp/mob-missing-ios-source")

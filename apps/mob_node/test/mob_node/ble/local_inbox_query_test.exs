defmodule Mob.Node.BLE.LocalInboxQueryTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.{LocalInbox, LocalInboxQuery, MessageEnvelope}
  ...
  defp snapshot do
    ...
    Map.put(
      base,
      :nearby_messages,
      Mob.Node.BLE.LocalInboxView.nearby_messages(base, now: 100, stale_after_ms: 10)
    )
  end

defmodule Mob.Node.NativeBridge.AndroidTest do
  use ExUnit.Case, async: true

  alias Mob.Node.BLE.Adapter
  alias Mob.Node.NativeBridge.Android
  ...
  test "host stub calls fail closed when native BLE is unavailable" do
    ...
    assert {:error, :native_not_available} = Android.start_advertising(self(), "mob-mob")

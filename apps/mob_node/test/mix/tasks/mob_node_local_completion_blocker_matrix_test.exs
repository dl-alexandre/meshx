defmodule Mix.Tasks.Mob.NodeLocalCompletionBlockerMatrixTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalCompletion.BlockerMatrix

  setup do
    Mix.Task.reenable("mob.node.local_completion.blocker_matrix")

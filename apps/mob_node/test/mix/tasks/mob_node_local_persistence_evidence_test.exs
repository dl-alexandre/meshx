defmodule Mix.Tasks.Mob.NodeLocalPersistenceEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalPersistence.Evidence

  setup do
    Mix.Task.reenable("mob.node.local_persistence.evidence")

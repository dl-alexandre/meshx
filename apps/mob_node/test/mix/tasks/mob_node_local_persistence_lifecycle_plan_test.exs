defmodule Mix.Tasks.Mob.NodeLocalPersistenceLifecyclePlanTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalPersistence.LifecyclePlan

  setup do
    Mix.Task.reenable("mob.node.local_persistence.lifecycle_plan")

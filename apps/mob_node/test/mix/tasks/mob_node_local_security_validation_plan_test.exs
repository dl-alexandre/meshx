defmodule Mix.Tasks.Mob.NodeLocalSecurityValidationPlanTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalSecurity.ValidationPlan

  setup do
    Mix.Task.reenable("mob.node.local_security.validation_plan")

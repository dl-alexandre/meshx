defmodule Mix.Tasks.Mob.NodeLocalSecurityReleaseReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalSecurity.ReleaseReview
  alias Mob.Node.BLE.LocalSecurityReleaseEvidenceReview

  setup do
    Mix.Task.reenable("mob.node.local_security.release_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "SECURITY_RELEASE_TEMPLATE command=mix mob.node.local_security.release_review --template"
  end

defmodule Mix.Tasks.Mob.NodeLocalReleaseArtifactBundleTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalRelease.ArtifactBundle

  setup do
    Mix.Task.reenable("mob.node.local_release.artifact_bundle")
  ...
  test "writes machine-readable JSON artifact" do
    ...
    assert decoded_file["required_commands"]
           |> Enum.any?(&String.contains?(&1, "mix mob.node.local_completion.audit --allow-open"))

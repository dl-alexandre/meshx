defmodule Mix.Tasks.Mob.NodeLocalInboxUxEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalInbox.UxEvidence

  setup do
    Mix.Task.reenable("mob.node.local_inbox.ux_evidence")

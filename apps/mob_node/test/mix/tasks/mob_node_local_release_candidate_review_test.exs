defmodule Mix.Tasks.Mob.NodeLocalReleaseCandidateReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalRelease.CandidateReview
  alias Mob.Node.BLE.LocalReleaseCandidateEvidenceReview

  setup do
    Mix.Task.reenable("mob.node.local_release.candidate_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "RELEASE_CANDIDATE_TEMPLATE command=mix mob.node.local_release.candidate_review --template"
  end
    ...
    %{
      ...
      "hardware_attachments" => [
        %{
          ...
          "summary_path" => "artifacts/mob-android-m59-gossip-live/summary.json",
          "raw_log_path" => "artifacts/mob-android-m59-gossip-live/sender.logcat",

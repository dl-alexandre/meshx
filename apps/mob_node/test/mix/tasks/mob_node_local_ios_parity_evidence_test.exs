defmodule Mix.Tasks.Mob.NodeLocalIosParityEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalIosParity.Evidence

  setup do
    Mix.Task.reenable("mob.node.local_ios_parity.evidence")

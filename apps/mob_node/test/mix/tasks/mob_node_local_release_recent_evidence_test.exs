defmodule Mix.Tasks.Mob.NodeLocalReleaseRecentEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalRelease.RecentEvidence

  setup do
    Mix.Task.reenable("mob.node.local_release.recent_evidence")

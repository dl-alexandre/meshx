defmodule Mix.Tasks.Mob.NodeLocalMultiHopHardwareEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalMultiHopHardware.Evidence

  setup do
    Mix.Task.reenable("mob.node.local_multi_hop_hardware.evidence")

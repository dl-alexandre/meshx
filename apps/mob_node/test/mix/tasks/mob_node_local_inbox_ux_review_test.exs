defmodule Mix.Tasks.Mob.NodeLocalInboxUxReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalInbox.UxReview
  alias Mob.Node.BLE.LocalInboxUxEvidenceReview

  setup do
    Mix.Task.reenable("mob.node.local_inbox.ux_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "LOCAL_INBOX_UX_TEMPLATE command=mix mob.node.local_inbox.ux_review --template"
  end
    ...
    %{
      "target_devices" => [
        %{
          ...
          "app_build_id" => "mob-local-debug-2026-05-13",

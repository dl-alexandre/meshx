defmodule Mix.Tasks.Mob.NodeLocalLifecycleValidationPlanTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalLifecycle.ValidationPlan

  setup do
    Mix.Task.reenable("mob.node.local_lifecycle.validation_plan")

defmodule Mix.Tasks.Mob.NodeLocalLifecycleEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Mob.Node.LocalLifecycle.Evidence

  setup do
    Mix.Task.reenable("mob.node.local_lifecycle.evidence")

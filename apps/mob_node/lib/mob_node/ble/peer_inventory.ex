defmodule Mob.Node.BLE.PeerInventory do
  @moduledoc """
  Pure-data view-model over `Mob.Node.BLE.PeerTable`.
  ...
  *logical peer* view from it:
  ...
  alias Mob.Node.BLE.PresencePolicy
  ...
  defmodule PeerSummary do
    ...
    @type t :: %__MODULE__{
            ...
            identity_source: Mob.Node.BLE.Identity.Claim.source(),
            capabilities: Mob.Node.BLE.PeerCapabilities.t(),
            presence: Mob.Node.BLE.PresencePolicy.state(),
    ...
    defstruct peer_id: nil,
              ...
              capabilities: %Mob.Node.BLE.PeerCapabilities{},

defmodule Mob.Node.BLE.LocalReleaseOperatorCapturePlan do
  @moduledoc """
  ...
  defp review_commands do
    [
      ...
      "mix mob.node.local_release.candidate_review --input artifacts/local-ble/<run-id>/release-candidate/evidence.json --json --out tmp/local-release-candidate-review.json"
    ]
  end
end

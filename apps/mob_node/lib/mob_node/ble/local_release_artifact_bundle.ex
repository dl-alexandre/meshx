defmodule Mob.Node.BLE.LocalReleaseArtifactBundle do
  @moduledoc """
  ...
  def artifacts do
    [
      %Artifact{
        ...
        source: "mix mob.node.local_readiness.audit --allow-open --out tmp/local-readiness.json",
      ...
      %Artifact{
        ...
        source: "mix mob.node.local_release.manifest --json --out tmp/local-release.json",
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.remaining_items.audit --json --out artifacts/local-ble/2026-05-17-sm-t577u-ipad9/manifests/focused-remaining-items-audit.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.remaining_items.audit | tee artifacts/local-ble/2026-05-17-sm-t577u-ipad9/manifests/focused-remaining-items-audit.txt",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_full_resolution.transport_review --template --out artifacts/local-ble/<run-id>/full-resolution/evidence.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_known_good_transport.review --template --out artifacts/local-ble/<run-id>/transport/evidence.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_inbox.ux_validation_plan --json --out tmp/local-inbox-ux-validation-plan.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_lifecycle.validation_plan --json --out tmp/local-lifecycle-validation-plan.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_lifecycle.hardware_review --template --out artifacts/local-ble/<run-id>/lifecycle/evidence.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_multi_hop_hardware.review --template --out artifacts/local-ble/<run-id>/multi-hop/evidence.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_persistence.production_review --template --out artifacts/local-ble/<run-id>/persistence/evidence.json && mix mob.node.local_persistence.production_review --input artifacts/local-ble/<run-id>/persistence/evidence.json --json --out tmp/local-persistence-production-review.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_routing.production_review --template --out artifacts/local-ble/<run-id>/routing/evidence.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_security.release_review --template --out artifacts/local-ble/<run-id>/security/evidence.json && mix mob.node.local_security.release_review --input artifacts/local-ble/<run-id>/security/evidence.json --json --out tmp/local-security-release-review.json",
        purpose:
      ...
      %Artifact{
        ...
        source:
          "mix mob.node.local_release.candidate_review --template --out artifacts/local-ble/<run-id>/release-candidate/evidence.json",
        purpose:

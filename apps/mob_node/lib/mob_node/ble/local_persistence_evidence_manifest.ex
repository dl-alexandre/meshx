defmodule Mob.Node.BLE.LocalPersistenceEvidenceManifest do
  @moduledoc """
  ...
  @required_commands [
    ...
    "mix test apps/mob_node/test/mob_node/ble/local_persistence_acceptance_test.exs",
    ...
    "mix test apps/mob_node/test/mob_node/ble/local_inbox_durable_snapshot_schema_policy_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_persistence_production_lifecycle_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_persistence_negative_validation_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_persistence_operator_capture_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_persistence_default_decision_scenario_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/session_test.exs"
  ]

defmodule Mob.Node.BLE.LocalIOSParityEvidenceManifest do
  @moduledoc """
  ...
  @required_commands [
    ...
    "mix test apps/mob_node/test/mob_node/ble/local_ios_advert_carrier_decision_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_acceptance_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_contract_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_decision_scenario_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_evidence_manifest_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_hardware_evidence_review_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_hardware_validation_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_negative_validation_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_operator_capture_plan_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_native_source_inventory_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_policy_test.exs",
    "mix test apps/mob_node/test/mob_node/ble/local_ios_parity_proof_plan_test.exs",
    "mix test apps/mob_node/test/mix/tasks/mob_node_local_ios_parity_evidence_test.exs",
    "mix test apps/mob_node/test/mix/tasks/mob_node_local_ios_parity_hardware_review_test.exs"
  ]
    ...
    [
      %{
        ...
        files: [
          ...
          "apps/mob_node/ios/MobBLEBridge.swift",
          "apps/mob_node/ios/mob_ble_nif.m"
        ],
        hardware_evidence: [
      ...
      %{
        ...
        files: [
          "apps/mob_node/android/app/src/androidTest/java/dev/mob/mob/ble/IOSAuxFullMxAdvertSmokeTest.kt",

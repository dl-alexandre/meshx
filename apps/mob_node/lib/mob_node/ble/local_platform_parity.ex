defmodule Mob.Node.BLE.LocalPlatformParity do
  @moduledoc """
  ...
  @entry_specs [
    %{
      ...
      evidence: [
        "/tmp/mob-android-m26b-legacy/summary.json",
    ...
    %{
      ...
      status: :hardware_validated,
      evidence: ["/tmp/mob-android-m59-gossip-live/summary.json"],
      notes: [
    ...
    %{
      ...
      evidence: [
        "apps/mob_node/lib/mob_node/ble/local_transport_lifecycle_profile.ex"
      ],
    ...
    %{
      ...
      capability: :legacy_beacon_gossip,
      status: :not_implemented,
      evidence: ["apps/mob_node/lib/mob_node/native_bridge/ios.ex"],
    ...
    %{
      ...
      evidence: [
        ...
        "apps/mob_node/lib/mob_node/ble/bridge_protocol.ex"
      ],
      notes: [

defmodule Mob.Node.BLE.LocalRoutingTable do
  @moduledoc """
  ...
  alias Mob.Node.BLE.{PeerCapabilities, PeerInventory}
  ...
  defp entry(%PeerSummary{} = summary) do
    ...
    blocked_reasons = entry_blockers(summary, mob_capable?)
    ...
    %Entry{
      ...
      mob_capable?: mob_capable?,
      forwardable?: blocked_reasons == [],
      blocked_reasons: blocked_reasons
    }
  end

  defp entry_blockers(%PeerSummary{} = summary, mob_capable?) do
    [
      ...
      if(not mob_capable?, do: :missing_mob_capability)
    ]

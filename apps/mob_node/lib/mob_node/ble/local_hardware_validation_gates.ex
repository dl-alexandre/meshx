defmodule Mob.Node.BLE.LocalHardwareValidationGates do
  @moduledoc """
  ...
  @gate_specs [
    ...
    %{
      ...
      status: :blocked,
      evidence: [
        "apps/mob_node/test/fixtures/advert_gossip_scenarios",
    ...
    %{
      ...
      status: :partial,
      evidence: [
        "apps/mob_node/lib/mob_node/native_bridge/ios.ex",
      ...
      notes: [
        ...
        "Android fetch from iOS MobFetchGattResponder is hardware validated on SM-T577U to iPad12,1.",
        "Android receive-side hash-cued auto-fetch from the iPad MobFetchGattResponder is hardware validated for the explicit foreground opt-in path.",

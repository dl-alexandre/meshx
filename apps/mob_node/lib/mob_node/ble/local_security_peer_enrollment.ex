defmodule Mob.Node.BLE.LocalSecurityPeerEnrollment do
  @moduledoc """
  ...
  alias Mob.Node.BLE.LocalSecurityPeerIdentityBinding
  alias Mob.Node.BLE.LocalSecurityPeerIdentityBinding.Binding

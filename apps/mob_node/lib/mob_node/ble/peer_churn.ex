defmodule Mob.Node.BLE.PeerChurn do
  @moduledoc """
  Pure churn diff between two `Mob.Node.BLE.PeerInventory` snapshots.
  ...
  defmodule ChurnEvent do
    ...
    @type t :: %__MODULE__{
            kind: kind(),
            peer_id: binary() | nil,
            previous_presence: Mob.Node.BLE.PresencePolicy.state() | nil,
            current_presence: Mob.Node.BLE.PresencePolicy.state() | nil,

defmodule Mob.Node.BLE.LocalIOSNativeSourceInventory do
  @moduledoc """
  ...
  @expected_files [
    %{
      id: :swift_bridge,
      path: "apps/mob_node/ios/MobBLEBridge.swift",
      markers: [
    ...
    %{
      id: :swift_peripheral,
      # NOTE: path NOT renamed by the mob_* refactor — the iOS bridge SPM
      # project at meshx_mobile/ is a separate Swift package, outside the
      # umbrella's rename scope. Renaming the directory + the SPM module
    ...
    %{
      id: :nif_bridge,
      path: "apps/mob_node/ios/mob_ble_nif.m",
      markers: [
        "mob_ble_emit_received_message_beacon",
    ...
    %{
      id: :ios_info_plist,
      path: "apps/mob_node/ios/Info.plist",
      markers: [
  ...
  defp resolve_path(root, path) do
    app_relative = String.replace_prefix(path, "apps/mob_node/", "")

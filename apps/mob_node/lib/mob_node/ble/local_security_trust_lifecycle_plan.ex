defmodule Mob.Node.BLE.LocalSecurityTrustLifecyclePlan do
  @moduledoc """
  ...
  def snapshot do
    gates = gates()
    validation = Mob.Node.BLE.LocalSecurityTrustLifecycleValidation.snapshot()
    replay_lifecycle = Mob.Node.BLE.LocalSecurityReplayLifecycleValidation.snapshot()

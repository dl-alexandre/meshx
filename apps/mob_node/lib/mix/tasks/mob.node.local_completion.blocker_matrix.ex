defmodule Mix.Tasks.Mob.Node.LocalCompletion.BlockerMatrix do
  @moduledoc """
  Emits the whole-project completion blocker matrix.

      mix mob.node.local_completion.blocker_matrix
      mix mob.node.local_completion.blocker_matrix --json
  ...
  alias Mob.Node.BLE.LocalProjectCompletionBlockerMatrix

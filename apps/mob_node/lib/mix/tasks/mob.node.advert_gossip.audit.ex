defmodule Mix.Tasks.Mob.Node.AdvertGossip.Audit do
  @moduledoc """
  Audits replay-only advert gossip scenario fixtures.

      mix mob.node.advert_gossip.audit path/to/scenario.json
      mix mob.node.advert_gossip.audit path/to/scenarios
  ...
  alias Mob.Node.BLE.AdvertGossipScenario

defmodule Mix.Tasks.Mob.Node.LocalInbox.UxValidationPlan do
  @moduledoc """
  Emits the Nearby Messages on-device UX validation plan.

      mix mob.node.local_inbox.ux_validation_plan
      mix mob.node.local_inbox.ux_validation_plan --json

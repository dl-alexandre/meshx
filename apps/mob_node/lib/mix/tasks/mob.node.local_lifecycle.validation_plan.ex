defmodule Mix.Tasks.Mob.Node.LocalLifecycle.ValidationPlan do
  @moduledoc """
  Emits the mobile BLE lifecycle hardware validation plan.

      mix mob.node.local_lifecycle.validation_plan
      mix mob.node.local_lifecycle.validation_plan --json
  ...
  alias Mob.Node.BLE.LocalLifecycleHardwareValidationPlan

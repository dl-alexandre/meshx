defmodule Mix.Tasks.Mob.Node.LocalRelease.CandidateReview do
  @moduledoc """
  Reviews advert-only local release-candidate evidence.

      mix mob.node.local_release.candidate_review
      mix mob.node.local_release.candidate_review --template --out artifacts/local-ble/run/release-candidate/evidence.json
      mix mob.node.local_release.candidate_review --input artifacts/local-ble/run/evidence.json
      mix mob.node.local_release.candidate_review --input artifacts/local-ble/run/evidence.json --json --out tmp/local-release-candidate-review.json
  ...
  alias Mob.Node.BLE.LocalReleaseCandidateEvidenceReview
  ...
  defp maybe_print_template_hint(_review) do
    Mix.shell().info(
      "RELEASE_CANDIDATE_TEMPLATE command=mix mob.node.local_release.candidate_review --template --out artifacts/local-ble/<run-id>/release-candidate/evidence.json"
    )
  end

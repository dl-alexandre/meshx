defmodule Mix.Tasks.Mob.Node.LocalCompletion.Audit do
  @moduledoc """
  Emits the whole-project completion audit.

      mix mob.node.local_completion.audit
      mix mob.node.local_completion.audit --allow-open
      mix mob.node.local_completion.audit --allow-open --json
  ...
  alias Mob.Node.BLE.LocalProjectCompletionAudit

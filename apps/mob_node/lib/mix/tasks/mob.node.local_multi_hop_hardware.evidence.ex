defmodule Mix.Tasks.Mob.Node.LocalMultiHopHardware.Evidence do
  @moduledoc """
  Emits the local multi-hop hardware evidence manifest.

      mix mob.node.local_multi_hop_hardware.evidence
      mix mob.node.local_multi_hop_hardware.evidence --json

defmodule Mix.Tasks.Mob.Node.LocalFullResolution.Evidence do
  @moduledoc """
  Emits the local full-message resolution evidence manifest.

      mix mob.node.local_full_resolution.evidence
      mix mob.node.local_full_resolution.evidence --json

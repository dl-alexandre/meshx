defmodule Mix.Tasks.Mob.Node.Replay do
  @moduledoc """
  Replay a captured BLE v1 JSONL file into a fresh `Mob.Node.Session`.
  ...
  `Mob.Node.BLE.BridgeProtocol.decode/1` — the same path the
  ...
  def run(_) do
    Mix.raise("Usage: mix mob.node.replay <capture-file.jsonl>")
  end
end

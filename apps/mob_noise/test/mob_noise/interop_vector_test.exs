defmodule Mob.Noise.InteropVectorTest do
  @moduledoc """
  Pinned `Noise_XX_25519_ChaChaPoly_BLAKE2s` handshake vector.

  This file is the **shared source of truth** for the wire format the
  Elixir Decibel-backed `Mob.Noise.Session` and the Swift
  `Mob.Node/Noise.swift` implementation must both produce when given
  ...
  `mob_node/Tests/Mob.NodeTests/`, it should consume the same

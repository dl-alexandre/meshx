defmodule MeshxTransportBLE.Bridge do
  ...
  **Canonical definition (authoritative for the contract):**
  ...
  `{:ble_frame, ...}` event convention are identical. `MeshxTransportBLE` performs
  ...
  `@behaviour MeshxTransportBLE.Bridge` for MeshX-centric code.
  ...
  # (owned by mob_ble package, no meshx_* dependency).

defmodule MeshxMobileApp.MobBleTransportWiringTest do
  @moduledoc """
  Primary wiring test for the recommended production `mob_ble` path.

  Proves the end-to-end wire from `meshx_mobile_app` through
  `MeshxTransportBLE` into `Mob.Ble.MobileBridge` (the canonical impl of
  `Mob.Ble.Bridge`) works without device hardware.

  This is the canonical smoke test for `MeshxMobileApp.App.maybe_start_mob_ble_transport/0`

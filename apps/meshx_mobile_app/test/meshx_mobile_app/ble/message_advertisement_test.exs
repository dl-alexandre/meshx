defmodule MeshxMobileApp.BLE.MessageAdvertisementTest do
  use ExUnit.Case, async: true

  alias MeshxMobileApp.BLE.Events.{AdvertisementReceived, ReceivedMessage}
  alias MeshxMobileApp.BLE.{MessageAdvertisement, MessageEnvelope}

defmodule MeshxMobileApp.BLE.LocalIOSParityHardwareEvidenceReviewTest do
    ...
    Map.new(LocalIOSParityHardwareEvidenceReview.required_gates(), fn gate ->
      {Atom.to_string(gate),
       %{
         ...
         "test_command" =>
           "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_ios_parity_#{gate}_test.exs",
         "evidence_type" =>
           LocalIOSParityHardwareEvidenceReview.required_evidence_types()
           |> Map.fetch!(gate)
           |> Atom.to_string(),

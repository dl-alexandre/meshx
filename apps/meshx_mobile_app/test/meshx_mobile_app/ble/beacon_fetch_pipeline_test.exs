defmodule MeshxMobileApp.BLE.BeaconFetchPipelineTest do
  ...
  alias MeshxMobileApp.BLE.BeaconFetchAttemptLedger.FetchAttempt
  alias MeshxMobileApp.BLE.BeaconFetchDispatcher.DryRun
  ...
  defp envelope_like(peer_id) do
    %MeshxMobileApp.BLE.MessageEnvelope{
      message_id: <<0::128>>,
  ...
  test "candidate selection prefers sender hash, MeshX capability, confidence, and recency deterministically" do
    ...
    candidates =
      BeaconFetchPlanner.select(request, [
        summary("meshx-stale", presence: :stale, last_seen_at: 999),
        ...
        summary("meshx-verified", identity_confidence: :verified, last_seen_at: 300),

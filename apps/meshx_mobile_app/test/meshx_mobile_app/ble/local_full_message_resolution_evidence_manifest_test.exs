defmodule MeshxMobileApp.BLE.LocalFullMessageResolutionEvidenceManifestTest do
  ...
  test "manifest requires direct full-resolution evidence command gates" do
    ...
    required_test_paths = [
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_resolver_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_request_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_pipeline_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_transport_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_fetch_transport_validation_plan_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_full_message_resolution_evidence_manifest_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_full_message_resolution_evidence_review_test.exs",
      "apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_known_good_transport_evidence_review_test.exs",
      "apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_full_resolution_evidence_test.exs",
      "apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_full_resolution_transport_review_test.exs",
      "apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_known_good_transport_review_test.exs"
    ]

defmodule MeshxMobileApp.BLE.IdentityTest do
  use ExUnit.Case, async: true

  alias MeshxMobileApp.BLE.Identity
  ...
  describe "derive/1" do
    ...
    test "stops on zero-length padding" do
      # A `meshx-alpha` record sitting behind padding is unreachable.
    ...
    test "real captured iPad advertisement derives `meshx-ipad`" do
      ad =
        Base.decode64!(

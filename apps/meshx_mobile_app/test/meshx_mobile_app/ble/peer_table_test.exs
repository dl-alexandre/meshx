defmodule MeshxMobileApp.BLE.PeerTableTest do
  use ExUnit.Case, async: true

  alias MeshxMobileApp.BLE.{Events, MessageEnvelope, PeerTable}
  ...
  describe "peer_id derivation from advertisement" do
    test "named advertisement (meshx- prefix) sets peer_id on the entry" do
      e = %Events.DeviceDiscovered{
        device_id: "AA:11",
        transport: :ble,
        rssi: -50,

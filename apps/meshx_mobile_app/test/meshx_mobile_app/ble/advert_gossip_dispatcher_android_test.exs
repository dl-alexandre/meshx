defmodule MeshxMobileApp.BLE.AdvertGossipDispatcher.AndroidTest do
  use ExUnit.Case, async: true

  alias MeshxMobileApp.BLE.AdvertGossipDispatcher.Android
  alias MeshxMobileApp.BLE.AdvertGossipPlanner.Intent
  alias MeshxMobileApp.BLE.Events.AdvertGossipOutcome

defmodule Mix.Tasks.MeshxMobileLocalPersistenceProductionReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalPersistence.ProductionReview
  alias MeshxMobileApp.BLE.LocalPersistenceProductionEvidenceReview

  setup do
    Mix.Task.reenable("meshx.mobile.local_persistence.production_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "PERSISTENCE_PRODUCTION_TEMPLATE command=mix meshx.mobile.local_persistence.production_review --template"
  end

defmodule Mix.Tasks.MeshxMobileLocalSecurityEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalSecurity.Evidence

  setup do
    Mix.Task.reenable("meshx.mobile.local_security.evidence")

defmodule Mix.Tasks.MeshxMobileLocalFullResolutionTransportReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalFullResolution.TransportReview
  alias MeshxMobileApp.BLE.LocalFullMessageResolutionEvidenceReview

  setup do
    Mix.Task.reenable("meshx.mobile.local_full_resolution.transport_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "FULL_RESOLUTION_TRANSPORT_TEMPLATE command=mix meshx.mobile.local_full_resolution.transport_review --template"
  end

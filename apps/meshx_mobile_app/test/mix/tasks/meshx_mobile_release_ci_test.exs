defmodule Mix.Tasks.MeshxMobileReleaseCITest do
  ...
  test "release docs require plain-text completion audit open item review" do
    ...
    assert artifact_bundle_doc =~ "mix meshx.mobile.remaining_items.audit --json"
    assert artifact_bundle_doc =~ "mix meshx.mobile.local_release.recent_evidence --json"
    ...
    assert release_doc =~ "mix meshx.mobile.remaining_items.audit --json"
    assert release_doc =~ "mix meshx.mobile.local_release.recent_evidence --json"

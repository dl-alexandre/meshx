defmodule Mix.Tasks.MeshxMobileLocalFullResolutionEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalFullResolution.Evidence

  setup do
    Mix.Task.reenable("meshx.mobile.local_full_resolution.evidence")

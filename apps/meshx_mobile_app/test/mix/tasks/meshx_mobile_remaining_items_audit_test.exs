defmodule Mix.Tasks.MeshxMobileRemainingItemsAuditTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.RemainingItems.Audit

  setup do
    Mix.Task.reenable("meshx.mobile.remaining_items.audit")

defmodule Mix.Tasks.MeshxMobileLocalInboxUxValidationPlanTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalInbox.UxValidationPlan

  setup do
    Mix.Task.reenable("meshx.mobile.local_inbox.ux_validation_plan")

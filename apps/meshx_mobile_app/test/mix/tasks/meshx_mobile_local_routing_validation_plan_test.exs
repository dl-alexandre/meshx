defmodule Mix.Tasks.MeshxMobileLocalRoutingValidationPlanTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalRouting.ValidationPlan

  setup do
    Mix.Task.reenable("meshx.mobile.local_routing.validation_plan")

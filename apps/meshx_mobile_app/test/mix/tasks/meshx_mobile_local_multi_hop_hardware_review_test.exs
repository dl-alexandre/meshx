defmodule Mix.Tasks.MeshxMobileLocalMultiHopHardwareReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalMultiHopHardware.Review
  alias MeshxMobileApp.BLE.LocalMultiHopHardwareEvidenceReview

  setup do
    Mix.Task.reenable("meshx.mobile.local_multi_hop_hardware.review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "MULTI_HOP_HARDWARE_TEMPLATE command=mix meshx.mobile.local_multi_hop_hardware.review --template"
  end

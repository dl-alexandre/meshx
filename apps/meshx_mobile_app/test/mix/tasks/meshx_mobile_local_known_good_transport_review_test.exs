defmodule Mix.Tasks.MeshxMobileLocalKnownGoodTransportReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalKnownGoodTransport.Review
  alias MeshxMobileApp.BLE.LocalKnownGoodTransportEvidenceReview

  setup do
    Mix.Task.reenable("meshx.mobile.local_known_good_transport.review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "KNOWN_GOOD_TRANSPORT_TEMPLATE command=mix meshx.mobile.local_known_good_transport.review --template"
  end

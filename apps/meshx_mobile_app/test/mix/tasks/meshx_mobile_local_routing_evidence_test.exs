defmodule Mix.Tasks.MeshxMobileLocalRoutingEvidenceTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalRouting.Evidence

  setup do
    Mix.Task.reenable("meshx.mobile.local_routing.evidence")

defmodule Mix.Tasks.MeshxMobileLocalIOSParityHardwareReviewTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalIosParity.HardwareReview
  alias MeshxMobileApp.BLE.LocalIOSParityHardwareEvidenceReview

  setup do
    Mix.Task.reenable("meshx.mobile.local_ios_parity.hardware_review")
  ...
  test "prints an open review summary without input" do
    ...
    assert output =~
             "IOS_PARITY_HARDWARE_TEMPLATE command=mix meshx.mobile.local_ios_parity.hardware_review --template"
  end

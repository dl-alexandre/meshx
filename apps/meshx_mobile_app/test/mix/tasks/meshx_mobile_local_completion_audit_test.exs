defmodule Mix.Tasks.MeshxMobileLocalCompletionAuditTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureIO

  alias Mix.Tasks.Meshx.Mobile.LocalCompletion.Audit

  setup do
    Mix.Task.reenable("meshx.mobile.local_completion.audit")
  ...
  test "prints machine-readable JSON when open items are allowed" do
    ...
    assert "mix meshx.mobile.local_completion.audit --allow-open" in decoded[
             "required_commands"
           ]

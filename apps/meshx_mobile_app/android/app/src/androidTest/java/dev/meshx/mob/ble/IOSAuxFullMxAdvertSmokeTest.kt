 ...
 *   adb shell am instrument -w -e class dev.meshx.mob.ble.IOSAuxFullMxAdvertSmokeTest \
 ...
 *   adb shell am instrument -w -e class dev.meshx.mob.ble.IOSAuxFullMxAdvertSmokeTest#emitsServiceDataFullMxEnvelope \
 *     dev.meshx.mob.test/androidx.test.runner.AndroidJUnitRunner
 *
 * 4. Hybrid (MB legacy cue + service-data full payload) — the next evolution:
 *   adb shell am instrument -w -e class dev.meshx.mob.ble.IOSAuxFullMxAdvertSmokeTest#emitsHybridMbCuePlusServiceDataFullMxEnvelope \
 *     dev.meshx.mob.test/androidx.test.runner.AndroidJUnitRunner
 *
...
class IOSAuxFullMxAdvertSmokeTest {
    ...
    fun emitsServiceDataFullMxEnvelope() {
        ...
        // service data under MESHX_DIRECT_MX_SERVICE_UUID instead of manufacturer data.
        ...
        val result = BleDispatcher(adapter, InMemoryEventSink()).dispatch(
            ...
            serviceDataUuid = BleDispatcher.MESHX_DIRECT_MX_SERVICE_UUID
        )
    ...
    fun emitsHybridMbCuePlusServiceDataFullMxEnvelope() {
        ...
        // - service data for MESHX_DIRECT_MX_SERVICE_UUID containing the full envelope
    ...
    // + also emit the full MX envelope via service data on MESHX_DIRECT_MX_SERVICE_UUID.

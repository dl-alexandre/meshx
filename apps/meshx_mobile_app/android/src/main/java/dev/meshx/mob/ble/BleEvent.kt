 ...
 * `MeshxMobileApp.BLE.BridgeProtocol`. Every event the Android transport
...
sealed class BleEvent {
    ...
    /**
     * `kind` must be drawn from `MeshxMobileApp.BLE.Error.kinds/0`. Anything
    ...
    companion object {
        ...
        // Closed taxonomy mirror of MeshxMobileApp.BLE.Error.kinds/0. Kept

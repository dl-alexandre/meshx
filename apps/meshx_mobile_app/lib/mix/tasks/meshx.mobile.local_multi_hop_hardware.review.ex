defmodule Mix.Tasks.Meshx.Mobile.LocalMultiHopHardware.Review do
  @moduledoc """
  Reviews physical multi-hop advert gossip evidence metadata.

      mix meshx.mobile.local_multi_hop_hardware.review
      mix meshx.mobile.local_multi_hop_hardware.review --template --out artifacts/local-ble/run/multi-hop/evidence.json
      mix meshx.mobile.local_multi_hop_hardware.review --input artifacts/local-ble/run/multi-hop/evidence.json
      mix meshx.mobile.local_multi_hop_hardware.review --input artifacts/local-ble/run/multi-hop/evidence.json --json --out tmp/local-multi-hop-hardware-review.json
  ...
  alias MeshxMobileApp.BLE.LocalMultiHopHardwareEvidenceReview
  ...
  defp maybe_print_template_hint(_review) do
    Mix.shell().info(
      "MULTI_HOP_HARDWARE_TEMPLATE command=mix meshx.mobile.local_multi_hop_hardware.review --template --out artifacts/local-ble/<run-id>/multi-hop/evidence.json"
    )
  end
end

defmodule Mix.Tasks.Meshx.Mobile.LocalRelease.ArtifactBundle do
  @moduledoc """
  Emits the advert-only local mesh release artifact bundle checklist.

      mix meshx.mobile.local_release.artifact_bundle
      mix meshx.mobile.local_release.artifact_bundle --json
  ...
  alias MeshxMobileApp.BLE.LocalReleaseArtifactBundle

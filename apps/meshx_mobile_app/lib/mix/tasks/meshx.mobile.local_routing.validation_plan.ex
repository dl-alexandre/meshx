defmodule Mix.Tasks.Meshx.Mobile.LocalRouting.ValidationPlan do
  @moduledoc """
  Emits the production routing hardware validation plan.

      mix meshx.mobile.local_routing.validation_plan
      mix meshx.mobile.local_routing.validation_plan --json

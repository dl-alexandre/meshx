defmodule Mix.Tasks.Meshx.Mobile.LocalSecurity.ValidationPlan do
  @moduledoc """
  Emits the authenticated local BLE security validation plan.

      mix meshx.mobile.local_security.validation_plan
      mix meshx.mobile.local_security.validation_plan --json

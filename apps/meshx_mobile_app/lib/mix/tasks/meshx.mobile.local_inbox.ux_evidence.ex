defmodule Mix.Tasks.Meshx.Mobile.LocalInbox.UxEvidence do
  @moduledoc """
  Emits the Nearby Messages UX evidence manifest.

      mix meshx.mobile.local_inbox.ux_evidence
      mix meshx.mobile.local_inbox.ux_evidence --json
  ...
  alias MeshxMobileApp.BLE.LocalInboxUxEvidenceManifest

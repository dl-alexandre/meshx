defmodule Mix.Tasks.Meshx.Mobile.LocalPersistence.Evidence do
  @moduledoc """
  Emits the local inbox persistence evidence manifest.

      mix meshx.mobile.local_persistence.evidence
      mix meshx.mobile.local_persistence.evidence --json
  ...
  alias MeshxMobileApp.BLE.LocalPersistenceEvidenceManifest

defmodule Mix.Tasks.Meshx.Mobile.LocalInbox.UxReview do
  @moduledoc """
  Reviews Nearby Messages on-device UX evidence metadata.

      mix meshx.mobile.local_inbox.ux_review
      mix meshx.mobile.local_inbox.ux_review --template --out artifacts/local-ble/run/ux/evidence.json
      mix meshx.mobile.local_inbox.ux_review --input artifacts/local-ble/run/ux/evidence.json
      mix meshx.mobile.local_inbox.ux_review --input artifacts/local-ble/run/ux/evidence.json --json --out tmp/local-inbox-ux-review.json
  ...
  defp maybe_print_template_hint(_review) do
    Mix.shell().info(
      "LOCAL_INBOX_UX_TEMPLATE command=mix meshx.mobile.local_inbox.ux_review --template --out artifacts/local-ble/<run-id>/ux/evidence.json"
    )
  end
end

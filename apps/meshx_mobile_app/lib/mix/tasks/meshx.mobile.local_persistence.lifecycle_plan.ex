defmodule Mix.Tasks.Meshx.Mobile.LocalPersistence.LifecyclePlan do
  @moduledoc """
  Emits the production-default local inbox persistence lifecycle plan.

      mix meshx.mobile.local_persistence.lifecycle_plan
      mix meshx.mobile.local_persistence.lifecycle_plan --json
  ...
  alias MeshxMobileApp.BLE.LocalPersistenceProductionLifecyclePlan

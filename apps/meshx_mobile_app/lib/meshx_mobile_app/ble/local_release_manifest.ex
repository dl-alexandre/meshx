defmodule MeshxMobileApp.BLE.LocalReleaseManifest do
  @moduledoc """
  ...
  @required_commands [
    ...
    "mix meshx.mobile.local_completion.audit --allow-open --json --out <path>",
    ...
    "mix meshx.mobile.local_full_resolution.evidence --json --out <path>",
    "mix meshx.mobile.local_full_resolution.transport_review --template --out <path>",
    "mix meshx.mobile.local_full_resolution.transport_review --input <path> --json --out <path>",
    "mix meshx.mobile.local_inbox.ux_validation_plan --json --out <path>",
    "mix meshx.mobile.local_inbox.ux_evidence --json --out <path>",
    "mix meshx.mobile.local_inbox.ux_review --template --out <path>",
    ...
    "mix meshx.mobile.local_known_good_transport.review --input <path> --json --out <path>",
    ...
    "mix meshx.mobile.local_lifecycle.hardware_review --input <path> --json --out <path>",
    "mix meshx.mobile.local_multi_hop_hardware.evidence --json --out <path>",
    "mix meshx.mobile.local_multi_hop_hardware.review --template --out <path>",
    "mix meshx.mobile.local_multi_hop_hardware.review --input <path> --json --out <path>",
    ...
    "mix meshx.mobile.local_routing.evidence --json --out <path>",
    "mix meshx.mobile.local_routing.production_review --template --out <path>",
    "mix meshx.mobile.local_routing.production_review --input <path> --json --out <path>",
    "mix meshx.mobile.local_security.validation_plan --json --out <path>",
    "mix meshx.mobile.local_security.evidence --json --out <path>",
    "mix meshx.mobile.local_security.release_review --template --out <path>",
    "mix meshx.mobile.local_security.release_review --input <path> --json --out <path>",
  ...
  defp required_artifacts do
    [
      %{
        ...
        command: "mix meshx.mobile.local_readiness.audit --allow-open --json --out <path>",
        purpose: "Archive open whole-project blockers and partial items."
      },
      %{
        id: :completion_audit_manifest,
        command: "mix meshx.mobile.local_release.manifest --json --out <path>",
        purpose: "Archive the whole-project completion claim gate and every open blocker."
      },
      %{
        id: :completion_audit_standalone,
        command: "mix meshx.mobile.local_completion.audit --allow-open --json --out <path>",
      ...
      %{
        ...
        command: "mix meshx.mobile.local_completion.blocker_matrix --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_inbox.ux_evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_inbox.ux_review --template --out <path>",
        purpose:
          "Generate incomplete operator metadata scaffold for target-device UX attachments."
      },
      %{
        id: :ux_evidence_review,
        command: "mix meshx.mobile.local_inbox.ux_review --input <path> --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_full_resolution.evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_known_good_transport.review --template --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_lifecycle.validation_plan --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_lifecycle.evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_lifecycle.hardware_review --template --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_multi_hop_hardware.evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_multi_hop_hardware.review --template --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_routing.validation_plan --json --out <path>",
        purpose:
          "Archive the production routing hardware validation checklist before operator evidence review."
      },
      %{
        id: :routing_evidence_manifest,
        command: "mix meshx.mobile.local_routing.evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_routing.production_review --template --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_release.artifact_bundle --json --out <path>",
        purpose:
          "Archive the release-candidate artifact bundle checklist and open operator attachments."
      },
      %{
        id: :recent_evidence_inventory,
        command: "mix meshx.mobile.local_release.recent_evidence --json --out <path>",
      ...
      %{
        ...
        command: "mix meshx.mobile.local_release.candidate_review --template --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_security.validation_plan --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_security.evidence --json --out <path>",
        purpose:
      ...
      %{
        ...
        command: "mix meshx.mobile.local_security.release_review --template --out <path>",
        purpose:

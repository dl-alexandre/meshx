defmodule MeshxMobileApp.BLE.LocalMultiHopHardwareEvidenceManifest do
  @moduledoc """
  ...
  @scenario_fixture_path "apps/meshx_mobile_app/test/fixtures/advert_gossip_scenarios"
  ...
  @required_commands [
    ...
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_advert_gossip_hardware_validation_plan_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_hardware_validation_gates_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_multi_hop_hardware_evidence_manifest_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_multi_hop_hardware_evidence_review_test.exs",
    "mix test apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_multi_hop_hardware_evidence_test.exs",
    "mix test apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_multi_hop_hardware_review_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/advert_gossip_scenario_test.exs"
  ]

defmodule MeshxMobileApp.BLE.LocalFullMessageResolutionEvidenceManifest do
  @moduledoc """
  ...
  @required_commands [
    ...
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_resolver_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_request_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_pipeline_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/beacon_fetch_transport_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_fetch_transport_validation_plan_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_full_message_resolution_evidence_manifest_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_full_message_resolution_evidence_review_test.exs",
    "mix test apps/meshx_mobile_app/test/meshx_mobile_app/ble/local_known_good_transport_evidence_review_test.exs",
    "mix test apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_full_resolution_evidence_test.exs",
    "mix test apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_full_resolution_transport_review_test.exs",
    "mix test apps/meshx_mobile_app/test/mix/tasks/meshx_mobile_local_known_good_transport_review_test.exs"
  ]

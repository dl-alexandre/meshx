defmodule MeshxMobileApp.BLE.BeaconFetchPlanner do
  @moduledoc """
  ...
  alias MeshxMobileApp.BLE.{BeaconFetchRequest, PeerCapabilities}
  ...
  defp meshx_capable_rank(%PeerSummary{capabilities: caps}) do

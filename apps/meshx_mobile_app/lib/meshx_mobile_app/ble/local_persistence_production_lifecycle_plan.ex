defmodule MeshxMobileApp.BLE.LocalPersistenceProductionLifecyclePlan do
  @moduledoc """
  ...
  def snapshot do
    ...
    %{
      ...
      schema_policy: MeshxMobileApp.BLE.LocalInboxDurableSnapshotSchemaPolicy.snapshot(),

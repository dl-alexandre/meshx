defmodule MeshxMobileApp.BLE.LocalProjectCompletionAudit do
  @moduledoc """
  ...
  alias MeshxMobileApp.BLE.{LocalProjectCompletionBlockerMatrix, LocalProjectReadiness}
  ...
  @review_template_commands [
    ...
    %{
      ...
      template_command: "mix meshx.mobile.local_inbox.ux_review --template --out <path>",
      review_command: "mix meshx.mobile.local_inbox.ux_review --input <path> --json --out <path>"
    },
    %{
    ...
    %{
      ...
      template_command: "mix meshx.mobile.local_release.candidate_review --template --out <path>",
      review_command:
        "mix meshx.mobile.local_release.candidate_review --input <path> --json --out <path>"
    },
    %{
    ...
    %{
      ...
      template_command: "mix meshx.mobile.local_security.release_review --template --out <path>",
      review_command:
        "mix meshx.mobile.local_security.release_review --input <path> --json --out <path>"
    }
  ]

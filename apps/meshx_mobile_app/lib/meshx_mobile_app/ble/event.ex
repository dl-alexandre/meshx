defmodule MeshxMobileApp.BLE.Event do
  @moduledoc """
  Sum type over canonical BLE events emitted by every platform bridge.

  Both `MeshxMobileApp.BLE.Adapter` implementations (iOS today, Android
  next) emit only these structs through `MeshxMobileApp.BLE.Adapter.event_message/1`.

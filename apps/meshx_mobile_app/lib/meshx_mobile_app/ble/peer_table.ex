defmodule MeshxMobileApp.BLE.PeerTable do
  @moduledoc """
  In-memory inventory of BLE peers observed via canonical events.

  **Passive only.** Built solely from `MeshxMobileApp.BLE.Events.*` —
  ...
  `MeshxMobileApp.BLE.Identity.classify/1`, along with the evidence
  ...
  alias MeshxMobileApp.BLE.{Events, Identity, PeerCapabilities}
  alias MeshxMobileApp.BLE.Identity.Claim
  ...
  unchanged.
  """
  @spec update(t(), MeshxMobileApp.BLE.Event.t()) :: t()

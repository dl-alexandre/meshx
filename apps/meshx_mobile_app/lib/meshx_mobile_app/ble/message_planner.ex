defmodule MeshxMobileApp.BLE.MessagePlanner do
  @moduledoc """
  ...
  `MeshxMobileApp.BLE.PresencePolicy` — the clock is always an input,
  never a side effect.
  ...
  alias MeshxMobileApp.BLE.{MessageEnvelope, PeerCapabilities, PeerInventory, PresencePolicy}

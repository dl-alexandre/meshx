...
| 4 | E2E private message | Noise XX session plus encrypted private A to B; stable identity fingerprint. | `mob_noise` vectors pass; on-device E2E unverified. | 2 devices. |
